...
const ABI = require("../artifacts/contracts/BazRiotNFT.sol/BazRiotNFT.json");
...
async function main() {
  ...
  const NFT = await ethers.getContractFactory("BazRiotNFT");
  const nft = await NFT.attach("0xb37f403cFF4fe5055A2D32E55AC9261979F0F479");
