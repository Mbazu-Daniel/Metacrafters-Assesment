// This script batch mints BazRiotNFT ERC721A tokens.
...
async function main() {
  ...
  const contractAddress = "0xb37f403cFF4fe5055A2D32E55AC9261979F0F479";

  // Get the contract factory and attach it to the signer
  const BazRiotNFT = await ethers.getContractFactory("BazRiotNFT", signer);
  const contract = await BazRiotNFT.attach(contractAddress);
