...
const whiteListSubmit = async (e) => {
  ...
  return <div>
    ...
    <div className="container mx-auto mt-8">
      <div className="max-w-md mx-auto flex font-semibold text-2xl items-center bg-violet-300 uppercase
      justify-center shadow-md rounded px-8 py-6 text-white">
      Add Stakeholder
      </div>
      <form className="max-w-md mx-auto bg-violet-200 shadow-md rounded px-8 py-6" onSubmit={handleSubmit}>
